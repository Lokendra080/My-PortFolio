...
const sendData = async(e)=>{
  ...
  const res= await fetch("https://my-portfoliobackend-qxeo.onrender.com/xyz", {
    method:"POST",
    headers:{
      ...
      <div className='Compo'>
        ...
        <div className='side'>
          <div className='footer-icon first'>
              ...
              <h5>lokendra.kumar08022000@gmail.com</h5>
                </div>
                <div className="contacticons">
            
            <i class="fi fi-ts-circle-phone"></i> <h5>
              +91 7428341336 </h5>
                
                </div>
                <div className="contacticons">
            <i class="fi fi-tr-land-layer-location"></i><h5>
               Govindpuri Kalkaji  Delhi-110019</h5>
